---
title: "15. ROC Analysis of Disease-Modified Taxa"
...
```{r}
source('Supp Scripts/15.1. PR-ROC Load Datasets - Status.R')
source('Supp Scripts/15.2. PR-ROC Functions.R')
```
...
p_noroc = ggarrange(plotlist = list(p$box,p$est),ncol = 1,nrow = 2,heights = c(1.2,1.5))

# Save plot
ggsave(plot = p$comb, '../Final Outputs/ROC/15. PRROC Model Fit - Status.png',height = 13, width = 10)
ggsave(plot = p_noroc, '../Final Outputs/ROC/15. PRROC Model Fit - Status - v2.png',height = 6, width = 10)
...
source('Supp Scripts/15.1. PR-ROC Load Datasets - Progression.R')
source('Supp Scripts/15.2. PR-ROC Functions.R')
...
p_noroc2 = ggarrange(plotlist = list(p2$box,p2$est),ncol = 1,nrow = 2,heights = c(1.3,1.5))

# Save plot
if(w){
  ggsave(plot = p2$comb, '../Final Outputs/ROC/15. PRROC Model Fit - Progression_weighted.png',height = 13, width = 12)
} else {
  ggsave(plot = p2$comb, '../Final Outputs/ROC/15. PRROC Model Fit - Progression_unweighted.png',height = 13, width = 12)
}

# Save plot
if(w){
  ggsave(plot = p_noroc2, '../Final Outputs/ROC/15. PRROC Model Fit - Progression_weighted_v2.png',height = 7, width = 12)
} else {
  ggsave(plot = p_noroc2, '../Final Outputs/ROC/15. PRROC Model Fit - Progression_unweighted_v2.png',height = 7, width = 12)
}
...
```{r}
ggsave(plot=p$box,'../Final Outputs/ROC/Box/Taxa - Status.png',height = 3, width = 10)
ggsave(plot=p2$box,'../Final Outputs/ROC/Box/Taxa - Progression.png',height = 3, width = 10)

ggsave(plot=p$roc,'../Final Outputs/ROC/ROC/Taxa - Status.png',height = 3, width = 10)
ggsave(plot=p2$roc,'../Final Outputs/ROC/ROC/Taxa - Progression.png',height = 3, width = 10)

ggsave(plot=p$est,'../Final Outputs/ROC/Est/Taxa - Status.png',height = 4, width = 10)
ggsave(plot=p2$est,'../Final Outputs/ROC/Est/Taxa - Progression.png',height = 4, width = 10)
```
