...
writexl::write_xlsx(species %>% lapply(function(x)x$combined_res),'../Results/Supplementary Data/Differential Abundance/COG Enzymes_Stats.xlsx')
writexl::write_xlsx(species %>% lapply(function(x)x$significance_summary),'../Results/Supplementary Data/Differential Abundance/COG Enzymes_Summary.xlsx')
```
...
writexl::write_xlsx(species %>% lapply(function(x)x$combined_res),'../Results/Supplementary Data/Differential Abundance/KO Enzymes_Stats.xlsx')
writexl::write_xlsx(species %>% lapply(function(x)x$significance_summary),'../Results/Supplementary Data/Differential Abundance/KO Enzymes_Summary.xlsx')
```
...
writexl::write_xlsx(species %>% lapply(function(x)x$combined_res),'../Results/Supplementary Data/Differential Abundance/EC_Stats.xlsx')
writexl::write_xlsx(species %>% lapply(function(x)x$significance_summary),'../Results/Supplementary Data/Differential Abundance/EC_Summary.xlsx')
```