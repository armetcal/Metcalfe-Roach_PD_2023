...
u1 = readxl::read_xlsx('../Results/Supplementary Data/Differential Abundance/MetaCyc_Stats.xlsx',sheet='univar') %>% 
  combine_da_results(alpha=pval_cutoff,stat='p_val')
length(unique(u1$Species)) == nrow(u1) # True if no conflicting results

m1 = readxl::read_xlsx('../Results/Supplementary Data/Differential Abundance/MetaCyc_Stats.xlsx',sheet='multivar') %>% 
...
```{r Save Results}
writexl::write_xlsx(list('COG Stats' = f.L1),'../Results/Supplementary Data/Enrichment Analysis/COG.xlsx')
```
